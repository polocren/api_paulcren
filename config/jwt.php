...
return [
    ...
    */
    ...
    // Les cookies JWT de cette API sont utilisés en clair côté route API.
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Cookie options used by the application
    |--------------------------------------------------------------------------
    |
    | Ces options ne sont pas utilisées directement par le package,
    | mais elles servent à l'application pour créer les cookies d'auth.
    |
    */
